            ...
            <div className="littlePost_content">
                <div className="littlePost_information">
                    <div className="littlePost_description">
                        <p className='littlePost_date'>April 20, 2021</p>
                        <h2 className='littlePost_title'>Astronauts prep for new solar arrays on nearly seven-hour spacewalk</h2>
                    </div>
                    <div className="littlePost_image">
                        <img src="./public/littlePost.png" alt="image" />
                    </div>
                </div>
