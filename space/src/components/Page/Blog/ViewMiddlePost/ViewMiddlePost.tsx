            ...
            <div className="middlePost_content">
                <div className="middlePost_information">
                    <div className="middlePost_image">
                        <img src="./public/middlePost.png" alt="image" />
                    </div>
                    <div className="middleePost_description">
                        <p className='middlePost_date'>April 20, 2021</p>
                        <h2 className='middlePost_title'>Astronauts prep for new solar arrays on nearly seven-hour spacewalk</h2>
                    </div>
                </div>
