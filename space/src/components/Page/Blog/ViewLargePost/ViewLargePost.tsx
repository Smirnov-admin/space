            ...
            <div className="largePost_content">
                <div className="largePost_information">
                    <div className="largePost_description">
                        <p className='largePost_date'>April 20, 2021</p>
                        <h2 className='largePost_title'>Astronauts prep for new solar arrays on nearly seven-hour spacewalk</h2>
                        <p className='largePost_text'>Astronauts Kayla Barron and Raja Chari floated out of the International Space Station airlock for a spacewalk Tuesday, installing brackets and struts to support new solar arrays to upgrade the research lab’s power system on the same day that crewmate Mark Vande Hei marked his 341st day in orbit, a U.S. record for a single spaceflight.</p>
                    </div>
                    <div className="largePost_image">
                        <img src="./public/largePost.png" alt="image" />
                    </div>
                </div>
